...
for repeat_i in range(repeat):
    ...
    with tf.Graph().as_default():
        ...
        train_op = model.training(all_class_loss, lr, l2_coef)
        ...
        with tf.Session(config=config) as sess:
            ...
            for epoch in range(nb_epochs):
                ...
                while tr_step * batch_size < tr_size:
                    ...
                    _, loss_list_tr, acc_list_tr = sess.run([train_op, loss, accuracy], feed_dict=fd)
                ...
                print('Training %s: loss = %.5f, %s = %.5f | Val: loss = %.5f, %s = %.5f' %
